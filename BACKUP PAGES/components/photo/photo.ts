...
export class PhotoPage {
  ...
  constructor(private location: Location, public cameraPreview: CameraPreview, public platform: Platform, public tabsService: TabsService, public storyService: StoryService,
